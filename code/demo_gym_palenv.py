...
parser.add_argument("--data", type=str, default=utils.getPathToExampleData().joinpath("5_bed-bpp.json"), help="Defines the used data.")
...
if __name__ == "__main__":
    ...
    env = wrappers.RescaleWrapper(base_env) # base_env = env.env
    env = wrappers.EquallyDistributedReward(env)
    ...
    # run evaluation
    cmd = ["python3", "script_evaluate_packing_plan.py", "--data", utils.PARSEDARGUMENTS["data"], "--packing_plan", utils.OUTPUTDIRECTORY.joinpath("packing_plans.json"), "-r"]
