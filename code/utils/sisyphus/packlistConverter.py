...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='This file converts the result of the solver `josch/sisyphus`, which was developed for VMAC 2012, to a format that can be used for the bed-bpp_env infrastructure.')
    parser.add_argument('--dir_solver', type=str, help="The directory that contains the packlists of the solver in xml format.", required=True)
    parser.add_argument('--src_order', type=str, help="The file that contains the order that is converted.", required=True)
