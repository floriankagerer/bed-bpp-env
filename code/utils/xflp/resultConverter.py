...
if __name__ == '__main__':
    ...
    parser.add_argument('--src_solver', type=str, default="java_output.txt", help="The source file that is converted to the needed format in Python.")
    parser.add_argument('--src_order', type=str, help="The order data that was used to create the solver output..")
    parser.add_argument('--dest', type=str, default="xflp_output.json", help="The file that holds the actions in the needed Python format.")
    parser.add_argument('--yaml', type=str, default="None", help="Defines the order that is converted to `.yaml`. Note that this can only be one order.")
