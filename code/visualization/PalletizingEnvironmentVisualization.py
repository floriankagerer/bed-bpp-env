...
class PalletizingEnvironmentVisualization(visualization.Visualization):
    ...
    def __init__(self, visID = "0", windowname = "Visualization | BED-BPP Environment", target:str = "euro-pallet", algo="") -> None:
    ...
    def __addEPAL(self) -> None:
        ...
        posCuboid = [   [0,offsetY+-400,-109], [532.5,offsetY+-400,-109], [1065,offsetY+-400,-109], 
                        [0,offsetY+-57.5,-109], [532.5,offsetY+-57.5,-109], [1065,offsetY+-57.5,-109],
                        [0,offsetY+285,-109], [532.5,offsetY+285,-109], [1065,offsetY+285,-109] ]
    ...
    def __addCuboid(self, dimension:tuple) -> None:
        ...
        BOTTOM_HEIGHT = 20
        targetComponentsSizes = [[10+dimension[0], 10+dimension[1], BOTTOM_HEIGHT], [5, 5, dimension[2]+BOTTOM_HEIGHT], [dimension[0]+10, 5, 5], [5, dimension[1]+10, 5]]
        
        # define the positions and measurements of the components
        posBaseArea = [[-5, -5, -20]]
        posVerticalStrip = [[-5, -5, -20], [dimension[0]+5, -5, -20], [-5, dimension[1]+5, -20], [dimension[0]+5, dimension[1]+5, -20]]
